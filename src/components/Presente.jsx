...
const Presente = () => {
  ...
  useEffect(() => {
    fetch('/estructura.xlsx')
      ...
      .then((ab) => {
        ...
        const filtrado = rows.filter((r) => r['tiempo']?.toLowerCase()?.trim() === 'presente'); // Filter for 'presente'
        setData(filtrado);
  ...
  const handleDownloadExcel = () => {
    ...
    saveAs(blob, `tiempo_presente_${new Date().toLocaleDateString()}.xlsx`); // File name for 'presente'
  };
  ...
  const handleDownloadPdf = () => {
    ...
    doc.setFontSize(18);
    doc.text("Tabla del Tiempo Presente", 14, 20); // Title for 'presente'
    ...
    doc.save(`tiempo_presente_${new Date().toLocaleDateString()}.pdf`); // File name for 'presente'
  };
  ...
  return (
    <div className="container mt-4">
      <div className="d-flex justify-content-between align-items-center mb-4">
        <h2 className="text-xl font-weight-bold">Tabla del Tiempo Presente</h2>
