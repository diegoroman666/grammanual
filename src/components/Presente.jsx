// src/pages/Presente.jsx (COMPLETO DE INICIO A FIN)
  ...
  useEffect(() => {
    fetch('/estructura.xlsx')
      ...
      .then((ab) => {
        ...
        // --- CAMBIO CLAVE AQUÍ: Filtrar para "presente" ---
        const filtrado = rows.filter((r) =>
          r['tiempo']?.toLowerCase()?.trim() === 'presente'
        );
  ...
  const handleCheck = async (index) => {
    ...
    try {
      ...
      setFeedbackData({
        ...
        explanation: `Ocurrió un error al verificar la gramática. Detalles: ${error.message}. Asegúrate de que tu clave API de Gemini esté configurada correctamente y de tener conexión a internet. (Podría ser un problema de cuota de API)`,
        suggestion: "",
        explanation_en: "",
        suggestion_en: ""
      });
  ...
  return (
    <div className="container mt-4"> 
      <div className="d-flex justify-content-between align-items-center mb-4">
        <h2 className="h4 mb-0">Tabla del Tiempo Presente</h2> {/* Título actualizado */}
