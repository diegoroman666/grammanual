// src/pages/Futuro.jsx (COMPLETO DE INICIO A FIN)
  ...
  useEffect(() => {
    fetch('/estructura.xlsx')
      ...
      .then((ab) => {
        ...
        // --- CAMBIO CLAVE AQUÍ: Filtrar para "futuro" ---
        const filtrado = rows.filter((r) =>
          r['tiempo']?.toLowerCase()?.trim() === 'futuro'
        );
  ...
  return (
    <div className="container mt-4"> 
      <div className="d-flex justify-content-between align-items-center mb-4">
        <h2 className="h4 mb-0">Tabla del Tiempo Futuro</h2> {/* Título actualizado */}
